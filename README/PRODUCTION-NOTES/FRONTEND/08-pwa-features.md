...
const CACHE_NAME = 'sociopredict-v1.0.0'
...
self.addEventListener('push', (event) => {
  ...
  const options = {
    ...
    image: data.image,
    tag: data.tag || 'sociopredict-notification',
    data: data.data,
    ...
    VitePWA({
      ...
      workbox: {
        ...
        runtimeCaching: [
          ...
          {
            urlPattern: /^https:\/\/api\.sociopredict\.com\/api\/users/,
            handler: 'NetworkFirst',
            options: {
              cacheName: 'api-users',
              expiration: {
...
const OFFLINE_STORAGE_KEY = 'sociopredict-offline'
