...
Bake the rendered vite.config.mjs into the prod image during ./SocioPredict install (prod).
...
// It becomes a concrete JS array literal like: ["sociopredict.com", "www.sociopredict.com"]
...
#   ENV_PATH=/root/sociopredict-deploy/.env scripts/prod/env_writer_prod.sh
...
#
# Requires FRONTEND_IMAGE_NAME in your .env (e.g., sociopredict-frontend).
