...
__SP_ROOT_DIR="${SOCIOPREDICT_ROOT:-$(cd "${__SP_DEV_DIR}/.." && pwd)}"
...
export BACKEND_IMAGE_NAME=${BACKEND_IMAGE_NAME:-sociopredict-dev-backend}
export FRONTEND_IMAGE_NAME=${FRONTEND_IMAGE_NAME:-sociopredict-dev-frontend}

# --- Main SocioPredict Functionality ---
...
BACKEND_IMAGE_NAME="${BACKEND_IMAGE_NAME:-sociopredict-dev-backend}"
FRONTEND_IMAGE_NAME="${FRONTEND_IMAGE_NAME:-sociopredict-dev-frontend}"
...
echo "Images built."
echo "Use "./SocioPredict up" to start the containers"
echo "And "./SocioPredict down" to stop them."
