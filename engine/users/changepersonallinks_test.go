...
func TestPersonalLinksValidation(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			links:         [4]string{"https://x.com/sociopredict", "", "https://linkedin.com/in/user", ""},
			expectedValid: true,
		},
		{
			name:          "Too long link",
		...
		},
		{
			...
			links:         [4]string{"https://x.com/sociopredict", "https://github.com/user", "https://linkedin.com/in/user", "https://instagram.com/user"},
			expectedValid: true,
		},
	}
