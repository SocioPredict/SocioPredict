...
import SocioPredictLogoPNG from '../../assets/png/SocioPredictLogo.png';
    ...
    <div className="min-h-[calc(100vh-6rem)] bg-primary-background text-custom-gray-verylight flex flex-col justify-center py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto w-full">
        <div className="flex flex-col sm:flex-row items-center mb-8">
          <img src={SocioPredictLogoPNG} alt="SocioPredict Logo" className="w-24 h-24 sm:w-32 sm:h-32 mb-4 sm:mb-0 sm:mr-6" />
          <div className="flex flex-col justify-center h-full text-center sm:text-left">
            <h1 className="text-3xl sm:text-4xl font-bold text-custom-gray-light mb-2">SocioPredict (BFF)</h1>
            <p className="text-lg text-custom-gray-light">An alpha project powered by SocioPredict's open-source prediction market platform.</p>
          </div>
        </div>
